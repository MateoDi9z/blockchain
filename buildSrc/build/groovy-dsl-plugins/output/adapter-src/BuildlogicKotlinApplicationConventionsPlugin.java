...
/**
 * Precompiled buildlogic.kotlin-application-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class BuildlogicKotlinApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BuildlogicKotlinApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("buildlogic.kotlin-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BuildlogicKotlinApplicationConventions").asSubclass(BasicScript.class);
