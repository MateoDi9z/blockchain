...
/**
 * Precompiled buildlogic.kotlin-common-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class BuildlogicKotlinCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BuildlogicKotlinCommonConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.jetbrains.kotlin.plugin.spring");
            target.getPluginManager().apply("org.springframework.boot");
            target.getPluginManager().apply("io.spring.dependency-management");
            target.getPluginManager().apply("org.jetbrains.kotlin.plugin.jpa");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BuildlogicKotlinCommonConventions").asSubclass(BasicScript.class);
